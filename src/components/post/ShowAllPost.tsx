...
function ShowAllPost() {
  ...
  return (
    <div className="flex flex-col gap-[1.25rem] mx-3">
      <div className="flex p-[1.125rem] gap-[2.1875rem] justify-center bg-white rounded-xl">
        <div className="flex gap-5">
          <Link to="/post/26be68a2-ec55-4fc7-bcae-3eb8d89929e1" className="relative min-w-[14.6875rem] max-w-[14.6875rem]">
          ...
          <div className="max-w-[26.125rem] max-h-[11rem] flex flex-col gap-2">
            <div>
              <Link to="/post/26be68a2-ec55-4fc7-bcae-3eb8d89929e1" className="font-bold xl:text-3xl lg:text-2xl md:text-base text-sm leading-6 text-[#353443]">
